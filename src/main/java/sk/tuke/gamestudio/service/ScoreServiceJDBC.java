...
//INSERT INTO score (player, game, points, playedon) VALUES ('jaro', 'pexeso', 200, '2017-03-02 14:30')

//SELECT player, game, points, playedon FROM score WHERE game = 'pexeso' ORDER BY points DESC LIMIT 10;
...
public class ScoreServiceJDBC implements ScoreService {
    ...
    public static void main ( String[] args ) throws Exception {
        Score score = new Score ( "pexeso" , "jaro" , 100 , new java.util.Date () );
        ScoreService scoreService = new ScoreServiceJDBC ();
        scoreService.addScore ( score );
        System.out.println ( scoreService.getBestScores ( "pexeso" ) );
    }
}
